//2025/3/13
// mip?vph_dist.txtを外から与える形式に変えた
// FIleStructure.cpp update
//wpb_v2のほうを修正
...
int main(int argc, char** argv) {
	if (argc != 10) {
		printf("argc %d\n", argc);
		fprintf(stderr, "usage:file-in-momch-all file-in-momch-mom sigma_list_water sigma_list_iron file-in-ECC file_in_base   mip_vph_distribution.txt file-out file_out_momch\n");
		exit(1);
	}
	...
	std::string in = argv[7];
	std::string file_out_difference = argv[8];
	std::string file_out_momch = argv[9];
